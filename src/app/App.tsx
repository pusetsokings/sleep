...
import { Home as HomeIcon, BookOpen, Calendar, User, CloudRain } from 'lucide-react';
...
import { Soundscapes } from '@/app/components/Soundscapes';
import { useLocalStorage } from '@/app/hooks/useLocalStorage';
import { UserProfile, SleepEntry, HabitEntry, WorryEntry, Strategy } from '@/app/types';

type View = 'home' | 'strategies' | 'strategy-journey' | 'track' | 'sleep-entry' | 'worry-entry' | 'analytics' | 'profile' | 'settings' | 'soundscapes';
          ...
          <div className="max-w-2xl mx-auto px-4">
            <div className="grid grid-cols-5 gap-1">
              <button
                ...
                className={`flex flex-col items-center py-3 px-2 transition-all duration-500 ${currentView === 'home'
              ...
              <button
                ...
                className={`flex flex-col items-center py-3 px-2 transition-all duration-500 ${currentView === 'strategies'
                  ? 'text-indigo-400 drop-shadow-[0_0_8px_rgba(129,140,248,0.6)] scale-105'
                  : 'text-slate-500 hover:text-indigo-300'
                  }`}
              ...
              <button
                ...
                className={`flex flex-col items-center py-3 px-2 transition-all duration-500 ${currentView === 'track'
                  ? 'text-indigo-400 drop-shadow-[0_0_8px_rgba(129,140,248,0.6)] scale-105'
                  : 'text-slate-500 hover:text-indigo-300'
                  }`}
              ...
              <button
                ...
                className={`flex flex-col items-center py-3 px-2 transition-all duration-500 ${currentView === 'profile'
                  ? 'text-indigo-400 drop-shadow-[0_0_8px_rgba(129,140,248,0.6)] scale-105'
                  : 'text-slate-500 hover:text-indigo-300'
                  }`}
